        ...
        <div className="w-full max-w-full ">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-blue-400 py-8 px-6">
            ...
            <div className="sm:grid sm:place-items-center">
              <button className="inline-block font-semibold  hover:bg-amber-400 transition duration-500 py-2 px-6 bg-blue-500 text-white tracking-widest uppercase rounded-md" >
