import logo from '../assets/JUNESTATE.svg'
...
const NavBar = () => {
  ...
  return (
    <div className='flex gap-10 bg-amber-400 text-white   w-full  relative  shadow-md duration-300 md:items-center justify-between h-20  md:gap-0 '>
      ...
      <ul className='flex   gap-5 items-center md:gap-3 '>
        ...
        <li><button><Link to='/houseList'  className='hover:border-b-2 hover:text-blue-400'>HOUSE LISTING</Link></button></li>
        <li><button><Link to='/more-services'  className='hover:border-b-2 hover:text-blue-400'>SERVICES</Link></button></li>
        <li><button><Link to='/contact-us'  className='hover:border-b-2 hover:text-blue-400'>CONTACT US</Link></button></li>
      </ul>
      <div className='flex gap-5 items-center md:gap-2 lg:ml-40'>
      <button className=' bg-blue-400  hover:bg-black transition duration-500 rounded-md w-20 h-10 my-10'><Link to='/login'> LOGIN</Link></button>
      <button className='bg-blue-400  hover:bg-black transition duration-500 rounded-md w-20 h-10 my-10 '><Link to='/register'>REGISTER</Link></button>
      </div>
      </nav>
      {showMenu?(
