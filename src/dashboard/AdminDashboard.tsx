...
import { CircleDollarSign, LayoutDashboard, CarFront, UserRoundCog, MapPin } from 'lucide-react';
      ...
      <div className="flex min-h-screen">
        <div className="w-full md:w-1/5 bg-gray-800 p-4 text-white md:block hidden">
          ...
          <ul>
            ...
            <li className="mb-2">
              <NavLink to="houses" className={({ isActive }) => `flex items-center text-white ${isActive ? 'text-blue-500' : ''}`}>
                <CarFront className="text-white mr-2" />
                Manage houses
              </NavLink>
            </li>
            <li className="mb-2">
              <NavLink to="book-house" className={({ isActive }) => `flex items-center text-white ${isActive ? 'text-blue-500' : ''}`}>
                <CarFront className="text-white mr-2" />
                house List
              </NavLink>
            </li>
