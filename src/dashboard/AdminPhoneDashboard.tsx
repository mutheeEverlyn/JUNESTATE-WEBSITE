...
const AdminPhoneDashboard =({showItems}:mobile) => {
  ...
  >
    ...
    <ul className="space-y-2 text-xl px-5">
        ...
        <li><button><Link to='houses'  className='hover:border-b-2 hover:text-blue-400 mb-2 inline-block text-white'>Manage Houses</Link></button></li>
        <li><button><Link to='book-house'  className='hover:border-b-2 hover:text-blue-400 mb-2 inline-block text-white'>Houses List</Link></button></li>
