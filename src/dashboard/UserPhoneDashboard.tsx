...
const UserPhoneDashboard =({showItems}:mobile) => {
  ...
  >
    ...
    <ul className="space-y-2 text-xl px-5">
        ...
        <li><button><Link to='book-house'  className='hover:border-b-2 hover:text-blue-400 mb-2 inline-block text-white'>Book a House</Link></button></li>
        <li><button><Link to='bookings'  className='hover:border-b-2 hover:text-blue-400 mb-2 inline-block text-white'>My bookings</Link></button></li>
        <li><button><Link to='my-tickets'  className='hover:border-b-2 hover:text-blue-400 mb-2 inline-block text-white'>My Tickets</Link></button></li>
        <li> <button><Link to='new-ticket'  className='hover:border-b-2 hover:text-blue-400 mb-2 inline-block text-white'>New Ticket</Link></button></li>
        <li> <button ><Link to='profile'  className='hover:border-b-2 hover:text-blue-400 mb-2 inline-block text-white'>My profile</Link></button></li>
      </ul>
    </div>
    </div>
    </div>
