...
import { useGetBookingsQuery, useDeleteBookingsMutation, TBookedHouses } from './BookingsApi';
...
const Bookings: React.FC = () => {
  ...
  const handleUpdate = async (booking: TBookedHouses) => {
    try {
  ...
  const MyBookings = bookings?.filter((booking: TBookedHouses) => booking.user_id === user_id);
        ...
        <table className="table table-xs">
          ...
          <tbody>
            {isLoading ? (
              ...
              MyBookings?.map((booking: TBookedHouses) => (
